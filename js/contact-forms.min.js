...
function toggleContactMethod(){const emailRadio=document.getElementById('issue-email-contact'),phoneRadio=document.getElementById('issue-phone-contact'),emailField=document.getElementById('issue-email-field'),phoneField=document.getElementById('issue-phone-field');emailRadio&&emailRadio.checked?(emailField.style.display='block',phoneField.style.display='none',document.getElementById('issue-phone').value='',clearFieldError('issue-phone','issue')):phoneRadio&&phoneRadio.checked?(phoneField.style.display='block',emailField.style.display='none',document.getElementById('issue-email').value='',clearFieldError('issue-email','issue')):emailField&&phoneField&&(emailField.style.display='block',phoneField.style.display='none')}
